...
const CategorySelector = () => {
  ...
  return (
    <div className="flex justify-center gap-4 mb-8 m-2 relative">
      {/* Film reel effect */}
      ...
      {categories.map((cat) => (
        <button
          ...
          className={`px-6 py-3 rounded-lg font-medium transition-all transform hover:scale-105 bg-black text-gray-300 hover:bg-gray-900 border border-gray-800
          `}
        >
          {cat.label}
        </button>
